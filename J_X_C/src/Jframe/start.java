...
public class start extends JFrame {
	...
	start() {
		...
		lblNewLabel = new JLabel("进销存信息管理系统");
		...
		lblNewLabel_3 = new JLabel("组长：   路人甲");
		...
		lblNewLabel_8 = new JLabel("指导老师：路人乙");
		...
		lblNewLabel_4 = new JLabel("组员：   路人");
	...
	private class sjb1 implements ActionListener{
		public void actionPerformed(ActionEvent e) {   ceshi1();  }   
								        public void    ceshi1(){
								        	dushuju_czy jcx=new dushuju_czy();
								        	jcx.dushuju();
								        	String uqc123=t1.getText();
								        	String pwd123=t2.getText();
								        	jxc_czy bank=new jxc_czy();
								        	op=bank.findOperatorByNameAndpwd(uqc123, pwd123);
									    	if(op==null){
									    		JOptionPane.showMessageDialog(null,"没有此账号或已经冻结或密码错误，请重新输入");
									    		t1.setText("");
									    		t2.setText("");
									    	}else{
